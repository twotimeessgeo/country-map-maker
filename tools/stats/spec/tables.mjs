    ...
    units: [
      ...
      unit("IV", "거주 공간의 변화와 지역 개발", [
        chapter("08", "촌락의 변화와 도시 발달", [
          ...
          t("k-4-03", "수도권과 강원 주요 도시 인구 변화 지수", null, "KOSIS DT_1YL20651E 도시별 장기 시계열과 교재 대상 도시"),
          t("k-4-04", "영남 주요 도시 인구 변화 지수", null, "KOSIS 도시별 장기 시계열과 교재 대상 도시"),
          t("k-4-05", "충청 주요 도시 인구 변화 지수", null, "KOSIS 도시별 장기 시계열과 교재 대상 도시"),
          t("k-4-06", "호남과 제주 주요 도시 인구 변화 지수", null, "KOSIS 도시별 장기 시계열과 교재 대상 도시"),
        ]),
      ...
      unit("V", "생산과 소비의 공간", [
        chapter("11", "자원의 의미와 자원 문제", [
          ...
          t("k-5-02", "시도별 1차 에너지 공급 비중", null, "에너지경제연구원 2025 지역에너지통계연보의 공급 표"),
          t("k-5-03", "시도별 1차 에너지 생산 비율", null, "에너지경제연구원 2025 지역에너지통계연보의 생산 표"),
          t("k-5-04", "에너지원별 발전량 비율", "kpx-generation", "EPSIS 전원별 전체 발전량(석탄·석유·천연가스·원자력·수력·신재생) 같은 연도 원표"),
          t("k-5-05", "도별 신재생 에너지 생산 비율", null, "한국에너지공단 2024 신재생에너지 보급통계 지역별 생산량"),
          t("k-5-06", "권역별 신재생 에너지 생산량", null, "한국에너지공단 2024 신재생에너지 보급통계 지역별 생산량"),
          extra("k-x-02", "시도별 최종에너지 소비량과 전력 판매량", "extra-energy"),
        ]),
        chapter("12", "농업의 변화와 공업 발달", [
          t("k-5-07", "도별 농가 수", "province-single:farm-households"),
          t("k-5-08", "도별 전업농가와 겸업농가 비율", null, "국가데이터처 농림어업총조사 경영형태 원표"),
          t("k-5-09", "도별 경지 면적과 경지율", null, "KOSIS korea_land_farm_2024 전체 경지 면적 및 면적 분모"),
          ...
          t("k-5-12", "0.5ha 미만 농가", null, "농림어업총조사 경영 규모 원표"),
          ...
          t("k-5-17", "시도별 제조업 사업체와 종사자", "province-manufacturing"),
          t("k-5-18", "시도별 제조업 출하액", null, "KOSIS DT_1FS1101 2024 출하액 원표"),
          t("k-5-19", "권역별 제조업 사업체와 종사자 및 출하액", null, "KOSIS DT_1FS1101 권역 합산 가능 원표"),
          t("k-5-20", "주요 제조업 전국 사업체와 종사자 및 출하액", null, "KOSIS DT_1FS1101 업종별 전국 원표"),
          t("k-5-21", "시도별 제조업별 출하액과 종사자", null, "KOSIS DT_1FS1101 시도·업종 교차 원표"),
          t("k-5-22", "권역별 제조업별 출하액 비율", null, "KOSIS DT_1FS1101 시도·업종 교차 원표"),
        ]),
        chapter("13", "교통과 서비스업의 변화", [
          t("k-5-23", "시도별 소매 업태 상위 지역", null, "KOSIS 서비스업조사 소매 업태별 시도 원표"),
          t("k-5-24", "시도별 취업자 수와 산업 구조", null, "KOSIS 지역별 고용조사 산업별 취업자 원표"),
      ...
      unit("VI", "인구 변화와 다문화 공간", [
        chapter("14", "인구 분포와 인구 구조의 변화", [
          ...
          t("k-6-03", "시도별 인구 구조", "province-age"),
          t("k-6-04", "권역별 인구 구조", null, "동일 시점 시도별 연령층 인구 원수"),
          t("k-6-05", "시도별 성비와 청장년층 성비", null, "KOSIS DT_1B04005N 2024 성별·연령별 주민등록인구"),
    ...
    units: [
      ...
      unit("III", "세계의 인문 환경과 인문 경관", [
        ...
        chapter("10", "에너지 자원과 국제 이동", [
          t("w-3-34", "세계 1차 에너지 소비 구조", null, "Energy Institute 세계 1차 에너지 소비 원표"),
          t("w-3-35", "1차 에너지 소비 상위 국가", null, "Energy Institute 전체 국가 소비 원표"),
          t("w-3-36", "대륙별 1차 에너지 소비 비중", null, "Energy Institute 대륙별 소비 원표"),
          t("w-3-37", "화석 에너지 생산과 소비 및 순수출입", null, "Energy Institute 석탄·석유·가스 생산·소비·교역 동일 연도 원표"),
          t("w-3-38", "주요국 원자력 소비와 발전 비율", "nuclear-countries"),
          t("w-3-39", "주요국 1차 에너지 소비 구조", "energy-countries"),
          t("w-3-40", "신재생 에너지원별 발전 비율 상위 국가", null, "Energy Institute 국가별 재생 발전 전체 원표"),
      ...
      unit("V", "건조 아시아와 북부 아프리카", [
        chapter("12", "건조 아시아와 북부 아프리카", [
          ...
          t("w-5-04", "주요국 화석 에너지 생산량", null, "Energy Institute 국가별 화석 에너지 생산 원표"),
