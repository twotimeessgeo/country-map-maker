...
if (isSourceCheck) {
  ...
  const checkView = (view, tableId) => {
    ...
    const sourceNames=new Set(["행정안전부","국가데이터처","국토교통부","농림축산식품부","에너지경제연구원","한국에너지공단","한국전력공사","한국전력거래소","한국교통연구원","FAOSTAT","UN","World Bank","Energy Institute","Ember","Pew Research Center","U.S. Census Bureau","WTO","IRENA","UNHCR","IEA","U.S. Geological Survey","UN Statistics Division","OEC","UNCTAD","World Mining Data","CIA World Factbook","OPEC"]);
