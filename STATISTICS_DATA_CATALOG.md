...
- 교재 기준값: 인구·농업·에너지·인구 구조 2023, 난민 2024
- 최신 가용값: 지표와 국가에 따라 2024~2025 값이 덧붙으며, `latest.year`를 실제 시점으로 사용함
...
| 레벨 | 의미 | 지역 수 | 지표 수 |
| --- | --- | ---: | ---: |
| `provinces` | 도/광역시 | 17 | 60 |
| `cities` | 시/군 | 154 | 42 |
| `metroDistricts` | 서울·부산 구/군 | 41 | 16 |
...
- 지역 169개
- 월 12개
- 일본 기상청(JMA) 1991-2020 평년값 145개 전면 반영
...
- `Af` 10, `Am` 3, `Aw` 27, `BS` 10, `Bw` 15
- `Cfa` 19, `Cfb` 21, `Cs` 17, `Cw` 5
- `Df` 19, `Dw` 9, `EF` 2, `ET` 4, `H` 8
...
- 지역 246개
- 남한 219개, 북한 27개
- 남한 관측망: ASOS 85개(기존 핵심 지점 42개 포함), AWS 134개
- 월 12개
...
- 수도권·서해 62, 강원 영서 11, 강원 영동 10, 충청 31, 호남 42, 영남 57, 제주 6
